...
/* For VENC */
#define VENC_MAX_CHN_NUM               0
#define VENC_MAX_ROI_NUM               0

/* For VDEC */
#define VDEC_MAX_CHN_NUM               0

/* For Region */
#define RGN_MAX_HANDLE_NUM             0
...
#define AF_MAX_CHN_NUM                 32
#define AF_MAX_MIX_CHN_NUM             8

/* For VPSS */
#define VPSS_MAX_GRP_NUM               0
#define VPSS_MAX_CHN_NUM               0
#define VPSS_MIN_IMAGE_WIDTH           0
#define VPSS_MIN_IMAGE_HEIGHT          0
#define VPSS_MAX_IMAGE_WIDTH           0
#define VPSS_MAX_IMAGE_HEIGHT          0
...
/* For TDE */
#define TDE_MAX_JOB_NUM                0
#define TDE_MAX_TASK_NUM               0
