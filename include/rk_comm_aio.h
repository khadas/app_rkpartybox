...
/*Defines sound card advanced param .*/
typedef struct rkAIO_ADVPARAM_S {
    RK_BOOL  bTstampModeDisable;
    RK_U32   u32AvailMin;
    RK_U32   u32PeriodCount;
    RK_U32   u32PeriodSize;
    RK_U32   u32PeriodStep;
    RK_U32   u32SilenceSize;
    RK_U32   u32SilenceThreshold;
    RK_U32   u32StartDelay;
    RK_U32   u32StopDelay;
    RK_U64   u64Boundary;
} AIO_ADVPARAM_S;
