...
#define KALAOK_REF_HARD_MODE    ECHO_REF_MODE_HARD_COMBO
...
#define HW_MIC_MATRIX   (BIT0_MIC_MUX)
#define HW_MIC_GUITAR_NUM      1//this include MIC and guitar
